...
create_table = "CREATE TABLE IF NOT EXISTS tickets (PNR INTEGER PRIMARY KEY AUTOINCREMENT DEFAULT 1000, seat_number TEXT DEFAULT 0, flight_id INTEGER NOT NULL, FOREIGN KEY (flight_id) REFERENCES flights(group_id))"
cursor.execute(create_table)
